...
class MyModel:
    ...
    def prediction(self, dataframe: pd.DataFrame) -> DataFrame:
        """
        ...
        try:
            ...
            #step1 : Apply SCaling transformations using the pre-trained preprocessing object
            transformed_feature = self.preprocessing_object.transform(dataframe)

            #step2: Perform prediction using the trained Model
